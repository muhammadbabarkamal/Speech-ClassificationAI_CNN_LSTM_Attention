...
from keras.layers import Add, Dropout, BatchNormalization, Conv2D,  MaxPooling2D, Dense,  LSTM, Bidirectional
...
def ConvSpeechModel(nCategories, samplingrate = 16000, inputLength = 16000):
    ...
    p6 = Flatten()(p5)
    p6 = Dense(64, activation = 'relu')(p6)
    p6 = Dense(32, activation = 'relu')(p6)
    p6 = Dropout(0.15) (p6)
    output = Dense(nCategories, activation = 'softmax')(p6)
...
def MultiHSpeechModel(nCategories, samplingrate = 16000, inputLength = 16000):
...
def AttRNNSpeechModel(nCategories, samplingrate = 16000, inputLength = 16000, rnn_func = LSTM):
    #simple LSTM
    sr = samplingrate
    iLen = inputLength
